...
<body>
  <!-- Start Navigation -->
  <nav class="navbar navbar-expand-sm navbar-dark bg-success pl-5 py-3 fixed-top">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="myMenu">
      <ul class="navbar-nav pl-5 custom-nav">
        <li class="nav-item"><li class="nav-item"><a href="index.php" class="nav-link" style="font-size:20px;">Home</a></li></li>
        <li class="nav-item"><a href="#Services" class="nav-link"style="font-size:20px;">Services</a></li>
        <li class="nav-item"><a href="#registration" class="nav-link"style="font-size:20px;">Registration</a></li>
        <li class="nav-item"><a href="Requester/RequesterLogin.php" class="nav-link"style="font-size:20px;">Login</a></li>
        <li class="nav-item"><a href="#Contact" class="nav-link"style="font-size:20px;">Contact</a></li>
      </ul>
    </div>
  </nav> <!-- End Navigation -->

  <!-- Start Header Jumbotron-->
  <header class="jumbotron back-image" style="background-image: url(images/b.jpg);">
    <div class="myclass mainHeading">
      <h1>Welcome to OSMS</h1>
      <p class="font-italic">Customer's Happiness is our Aim</p>
      <a href="Requester/RequesterLogin.php" class="btn btn-primary mr-4">Login</a>
      <a href="#registration" class="btn btn-warning mr-4">Sign Up</a>
    </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              <img src="images/avtar1.jpeg" class="img-fluid" style="border-radius:100px; with:50px">
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <p class="card-text">There is a big difference between a satisfied customer and a loyal customer. Never settle for ‘satisfied’.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title"> Vyas</h4>
              <p class="card-text">Loyal customers, they don’t just come back, they don’t simply recommend you, they insist that their friends do business with you.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Sinha</h4>
              <p class="card-text">A satisfied customer is one who will continue to buy from you, seldom shop around, refer other customers.</p>
            </div>
          </div>
  ...
  <!-- Start Footer-->
  <footer class="container-fluid bg-dark text-white mt-5" style="border-top: 3px solid yellow;">
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Irshad Alam-> 2026.
          </small>
